                ...
                >
                  <div className="flex justify-between items-start">
                    ...
                    <div className="text-right shrink-0">
                      <span className="text-sm font-extrabold text-slate-900 font-mono font-medium">PKR {opp.budget.toLocaleString()}</span>
              ...
              {successApply ? (
                ...
                <form onSubmit={handleApply} className="space-y-4 pt-2">
                  <div className="flex justify-between items-center bg-slate-50 p-2.5 rounded-xl border border-slate-100/80">
                    ...
                    >
                      ✦ {draftingAI ? "Synthesizing..." : "Auto Draft Proposals"}
                    </button>
                  </div>
