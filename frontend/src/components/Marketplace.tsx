    ...
    <div className="max-w-7xl mx-auto space-y-8 px-4 sm:px-6">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 bg-slate-950 text-white rounded-3xl p-8 shadow-xl border border-slate-800 relative overflow-hidden">
        ...
        {session?.role === UserRole.STUDENT && (
          <button 
            ...
            className="px-5 py-3 rounded-xl bg-white text-slate-955 font-bold text-xs uppercase flex items-center gap-1.5 hover:bg-slate-50 shrink-0 relative z-10 transition-all shadow-lg font-sans"
          >
      ...
      {showForm && (
        <form onSubmit={handlePublishGig} className="bg-white p-6 rounded-2xl border border-slate-200 shadow-sm space-y-4">
          <div className="flex justify-between items-center pb-2 border-b border-slate-100 font-sans">
            ...
            >
              ✦ {aiOptimizing ? "Optimizing copywriting..." : "Optimize with Gemini AI"}
            </button>
          </div>
            ...
            <div className="grid grid-cols-2 gap-2">
              ...
              <div className="space-y-1">
                ...
                <input 
                  ...
                  className="w-full text-xs px-3 py-2 border border-slate-300 rounded-lg text-slate-955 bg-white focus-visible:ring-2 focus-visible:ring-slate-900 focus:outline-none" 
                />
              </div>
            </div>
          </div>
          ...
          <div className="space-y-1 font-sans">
            ...
            <textarea 
              ...
              className="w-full text-xs px-3 py-2 border border-slate-300 rounded-lg text-slate-955 bg-white focus-visible:ring-2 focus-visible:ring-slate-900 focus:outline-none focus:ring-1 focus:ring-indigo-400" 
            />
          </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
        ...
        <div className="lg:col-span-1 bg-white p-6 rounded-3xl border border-slate-200 shadow-sm space-y-6 self-start">
          <h4 className="font-extrabold text-slate-900 text-sm flex items-center gap-2 font-sans">
          ...
          <div className="space-y-1.5 font-sans">
            ...
            <div className="relative">
              ...
              <input 
                ...
                className="w-full pl-9 pr-3 py-2 rounded-xl text-xs border border-slate-300 bg-white text-slate-955 focus-visible:ring-2 focus-visible:ring-slate-900 focus:outline-none"
              />
            </div>
          </div>
          ...
          <div className="space-y-1.5 font-sans">
            ...
            <select 
              ...
              className="w-full text-xs px-2.5 py-2.5 border border-slate-300 rounded-xl bg-white text-slate-955 focus-visible:ring-2 focus-visible:ring-slate-900 focus:outline-none"
            >
          ...
          <div className="flex items-center justify-between p-2.5 rounded-xl bg-indigo-50/50 border border-indigo-200 font-sans">
        ...
        <div className="lg:col-span-3 space-y-6">
          ...
          {filteredGigs.length === 0 ? (
            <div className="p-12 text-center text-slate-400 bg-white rounded-3xl border border-slate-100 text-xs font-sans">
                ...
                <div key={gig.id} className="bg-white rounded-3xl border border-slate-100 overflow-hidden flex flex-col justify-between hover:shadow-lg transition-all border-b-2 hover:border-b-indigo-400">
                  <div className="space-y-4">
                    ...
                    <div className="p-5 space-y-3">
                      ...
                      <h4 className="text-sm font-bold text-slate-900 leading-snug line-clamp-2 hover:text-indigo-600 transition-colors cursor-pointer font-sans">
                        {gig.title}
                      </h4>
                  ...
                  <div className="px-5 py-4 bg-slate-50/50 border-t border-slate-100/60 flex items-center justify-between font-sans">
                    <div>
                      <p className="text-[9px] font-mono font-bold text-slate-400 uppercase tracking-widest leading-none">Starting at</p>
                      <p className="text-base font-extrabold text-slate-955 font-mono mt-1 font-medium">Rs.{gig.startingPrice.toLocaleString()}</p>
                    </div>
