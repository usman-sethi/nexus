import { UserRole, VerificationStatus, StudentProfile, ServiceGig, Opportunity, Review } from "./types";
...
export const INITIAL_GIGS: ServiceGig[] = [
  {
    ...
    description: "Are you looking for a fully-featured, cross-platform app for your venture, institution, or startup? I offer modern mobile app development using React Native, TypeScript, and elegant Tailwind-like layout (NativeWind). Each build boasts rich features like maps grounding, persistent local caching, local SQLite integration, custom SVG charting, and seamless push notifications.",
    ...
    faqs: [
      {
        ...
        answer: "Yes, I configure Expo EAS pipelines to deliver live testing builds and scan codes on Android/iOS via TestFlight."
      },
      {
  ...
  },
  {
    ...
    description: "Unveil your product's potential with highly professional, elegant interactive custom prototypes designed strictly in Figma using Linear, Stripe-style aesthetic standards. I craft wireframes, interactive user flows, and extensive design tokens that match accessible WCAG guidelines.",
